...
class ManagerPays extends Connexion // hérite de la classe connexion
{
   ...
   public function getPays() { 
       $sql = 'SELECT * FROM tbl_pays order by nom_pays'; 
	   $pays = self::getConnexion()->query($sql);   // exécution directe , self:: opérateur de résolution de portée pour appeler des éléments appartenant à telle classe et non à tel objet
	   return $pays;        
    } 
